...
public class Pessoa_SkillService {
	...
	public Pessoa_SkillDTO atualizar(Integer id, Pessoa_SkillDTO Pessoa_SkillDTO) {
		try {
			Pessoa_Skill entity = pessoa_SkillRepositorio
					.findById(id)
					.orElseThrow(
	...
	@Transactional
	public UpdateLevel_PessoaSkillDTO atualizar(Integer id, UpdateLevel_PessoaSkillDTO UpdateLevel_PessoaSkillDTO) {
		try {
			Pessoa_Skill entity = pessoa_SkillRepositorio
					.findById(id)
					.orElseThrow(
							() -> new ResourceNotFoundException("Skill de pessoa nao encontrada"));
			copyDtoToLevelVersion(entity, UpdateLevel_PessoaSkillDTO);
			entity = pessoa_SkillRepositorio.save(entity);
			return new UpdateLevel_PessoaSkillDTO(entity);
		} catch (EntityNotFoundException e) {
			throw new ResourceNotFoundException("Recurso nao encontrado");
		}
	}
	...
	private void copyDtoToLevelVersion(Pessoa_Skill entity, UpdateLevel_PessoaSkillDTO UpdateLevel_PessoaSkillDTO) {

		entity.setKnowledge_level(UpdateLevel_PessoaSkillDTO.getKnowledge_level());
